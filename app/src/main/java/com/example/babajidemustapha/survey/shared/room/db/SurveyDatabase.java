...
public abstract class SurveyDatabase extends RoomDatabase {
    ...
    public abstract ResponseDetailDao responseDetailDao();

    public abstract ResponseHeaderDao responseHeaderDao();
...
//@Database(entities = {Survey.class,ResponseDetail.class, Question.class,ResponseHeader.class}, version = 1)
